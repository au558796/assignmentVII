...
m1<-glm(diagnosis ~ mean + range, data = df, family = "binomial")
summary(m1)
...
m2<-glmer(diagnosis ~ scale(range) + scale(mean) + (1+trial|participant), data = df, family = "binomial")
summary(m2)
...
dfpredict$diagnosis = df$dpredictions
...
fold_function(df, dfpredict, m2, 4)
...
m3<-glmer(diagnosis ~ scale(range) + scale(mean) + (1+trial|participant), data = df, family = "binomial")
m4<-glmer(diagnosis ~ scale(range) + scale(mean) + (1+trial|participant), data = df, family = "binomial")
m5<-glmer(diagnosis ~ scale(range) + scale(mean) + (1+trial|participant), data = df, family = "binomial")
m6<-glmer(diagnosis ~ scale(range) + scale(mean) + (1+trial|participant), data = df, family = "binomial")
m7<-glmer(diagnosis ~ scale(range) + scale(mean) + (1+trial|participant), data = df, family = "binomial")
m8<-glmer(diagnosis ~ scale(range) + scale(mean) + (1+trial|participant), data = df, family = "binomial")
  ##Remember:
